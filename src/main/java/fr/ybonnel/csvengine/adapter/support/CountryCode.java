package fr.ybonnel.csvengine.adapter.support;
...
public enum CountryCode
{
    ...
    public static CountryCode getByCode(String code)
    {
        ...
        switch (code.length())
        {
            ...
            default:	// JGS - added this call. Previously returned null.
    ...
    // JGS - added this method...and the used it.
    private static CountryCode getByName(String name) {
    	for(CountryCode country : values() ) {
    		int index = country.getName().toLowerCase().indexOf(name.toLowerCase());
